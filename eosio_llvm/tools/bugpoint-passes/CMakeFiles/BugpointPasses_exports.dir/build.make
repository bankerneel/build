...
tools/bugpoint-passes/BugpointPasses.exports: /home/ubuntu/eosio.cdt/eosio_llvm/tools/bugpoint-passes/bugpoint.exports
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/ubuntu/eosio.cdt/build/eosio_llvm/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Creating export file for BugpointPasses"
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && echo "LLVM_7 {" > BugpointPasses.exports
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && grep -q [[:alnum:]] /home/ubuntu/eosio.cdt/eosio_llvm/tools/bugpoint-passes/bugpoint.exports && echo "  global:" >> BugpointPasses.exports || :
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && sed -e "s/\$$/;/" -e "s/^/    /" < /home/ubuntu/eosio.cdt/eosio_llvm/tools/bugpoint-passes/bugpoint.exports >> BugpointPasses.exports
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && echo "  local: *;" >> BugpointPasses.exports
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && echo "};" >> BugpointPasses.exports
...
tools/bugpoint-passes/CMakeFiles/BugpointPasses_exports.dir/clean:
	cd /home/ubuntu/eosio.cdt/build/eosio_llvm/tools/bugpoint-passes && $(CMAKE_COMMAND) -P CMakeFiles/BugpointPasses_exports.dir/cmake_clean.cmake
